module OctaTree
  type Vector3<[<Measure>] 'a> =
    ...
    static member (*) (v1: Vector3<'a>, v2: Vector3<'b>): Vector3<'a * 'b> = { X = v1.X * v2.X; Y = v1.Y * v2.Y; Z = v1.Z * v2.Z }
    ...
    static member Distance (v1: Vector3<'a>, v2: Vector3<'a>): float<'a> = (v1 - v2).Length
    static member Normalize(v: Vector3<'a>): Vector3<1> = v.Normalized
    static member Dot (v1: Vector3<'a>, v2: Vector3<'b>): float<'a * 'b> = v1.X * v2.X + v1.Y * v2.Y + v1.Z * v2.Z
